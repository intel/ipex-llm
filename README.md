...
## Latest Update 🔥 
- [2025/05] The [FlashMoE](docs/mddocs/Quickstart/flashmoe_quickstart.md) support in `ipex-llm` runs ***DeepSeek V3/R1 671B*** and ***Qwen3MoE 235B*** models with just 1 or 2 Intel Arc GPU.
