...
>[!Important]
> You can now run **DeepSeek-R1-671B-Q4_K_M** with 1 or 2 Arc A770 on Xeon using the latest *llama.cpp Portable Zip*; see [below](#flashmoe-for-deepseek-v3r1) for details.
